...
The lesson belongs where the next person will meet it: a test, a lint rule, a hook, an alert, a line in `AGENTS.md`, or a checklist item in `definition-of-done`. An incident that changes no artefact will recur.
