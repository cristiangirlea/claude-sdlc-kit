...
1. **Discover the real commands.** Read `Makefile`, `package.json` scripts, `justfile`, `taskfile`, CI workflow files, and `AGENTS.md`. Use the project's own commands - do not invent `npm test` for a Go repo.
