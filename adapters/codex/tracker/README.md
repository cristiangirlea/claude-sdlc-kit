...
node ./scripts/tracker.mjs move TASK-1 in-progress
node ./scripts/tracker.mjs set TASK-1 branch=feat/TASK-1-saved-searches pr=123
node ./scripts/tracker.mjs comment TASK-1 "blocked on the auth decision"
node ./scripts/tracker.mjs report --days 7
node ./scripts/tracker.mjs next
```
