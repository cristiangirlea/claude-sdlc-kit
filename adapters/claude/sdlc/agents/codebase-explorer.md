...
<!-- Generated from src/agents/codebase-explorer.md by scripts/build.mjs. Edit the source, not this file. -->
...
assistant: "I will send the `codebase-explorer` agent through the fetcher path first so the plan matches how it is actually wired."
</example>
