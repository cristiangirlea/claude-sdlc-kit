...
```bash
node plugins/tracker/scripts/tracker.mjs new "Add saved searches" --type feature --priority P2
node plugins/tracker/scripts/tracker.mjs list --status ready
node plugins/tracker/scripts/tracker.mjs move TASK-1 in-progress
node plugins/tracker/scripts/tracker.mjs set TASK-1 branch=feat/TASK-1-saved-searches pr=123
node plugins/tracker/scripts/tracker.mjs comment TASK-1 "blocked on the auth decision"
node plugins/tracker/scripts/tracker.mjs report --days 7
node plugins/tracker/scripts/tracker.mjs next
```
